        ...
        <div className="home-div">
          <div className="image-div">
            ...
            <div className="home-text-div">
              ...
              imagined. The Theosophy Hall Theater in Los Angeles California has
               hosted countless spiritual and philosophical gatherings.  With the capacity for 350 guests, the Theosophy Hall provides a perfect blend of historical ambiance and
                modern amenities. 
              </p>

              <div className="learn-more-button">
              <Link href="/about" passHref style={{textDecoration: "none", color: "black"}}>
                LEARN MORE
              </Link>
              </div>
            </div>
